    ...
    <div style={{ minHeight:'100vh', background:'#F5F5F5', paddingBottom:100 }}>
      ...
      <div style={{ padding:'24px 24px 0' }}>
        ...
        <div className="tabs" style={{ marginBottom:16 }}>
          <button className={`tab ${tab==='overview'?'active':''}`} onClick={()=>setTab('overview')} style={{ fontSize:12 }}>📊 Overview</button>
          <button className={`tab ${tab==='members'?'active':''}`} onClick={()=>setTab('members')} style={{ fontSize:12 }}>👥 Members</button>
          <button className={`tab ${tab==='timeline'?'active':''}`} onClick={()=>setTab('timeline')} style={{ fontSize:12 }}>🕐 Timeline</button>
        </div>
