    ...
    <div style={{ minHeight: '100vh', background: '#F5F5F5', paddingBottom: 100 }}>
      ...
      <div style={{ padding: '24px 24px 0' }}>
        ...
        <div className="tabs" style={{ marginBottom: 16 }}>
          <button className={`tab ${tab === 'expenses' ? 'active' : ''}`} onClick={() => setTab('expenses')}><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M12 2v4"/><path d="M8 2h8"/><path d="M9 12h6"/><path d="M9 16h6"/></svg> Expenses</button>
