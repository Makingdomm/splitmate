      ...
      <div style={{ minHeight:'100vh', background:'#F5F5F5', paddingBottom:100 }}>
        ...
        <div style={{ padding:'24px' }}>
          ...
          <div className="card animate-in" style={{ marginBottom:24, background: isElite ? 'linear-gradient(135deg,#3A4219,#4B5320)' : 'linear-gradient(135deg,#4B5320,#6B7B3A)', textAlign:'center' }}>
            <div style={{ marginBottom:8 }}>{isElite ? <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 3L2 9L12 22L22 9L18 3H6Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 22V9" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 9H22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M6 3L9 9" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M18 3L15 9" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg> : <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>}</div>
